...
Use this guide to review the controlled beta, reproduce local checks and assess the model evidence.
...
| Is the extracted data useful? | [Pilot evaluation](LAUNCH_EVALUATION.md), [research results](archive/research/RESULTS.md), [claim boundaries](archive/research/RESULT_TO_CLAIM.md) | [Metrics](../unrender/eval/metrics.py), [frozen inputs](../release/launch-eval-v1/), [saved predictions](../release/launch-eval-results/) |
