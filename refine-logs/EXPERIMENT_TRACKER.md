...
| R007b | M2 | numeric-token-loss arm (co-headline) | LoRA + digit-token CE up-weight | train v1+v0 | val cell@5_exact | MUST | TODO | review: highest lift/$ (+2–5pp); run alongside geometry |
| R011b | M3 | FAIR baseline ablation | table-only LoRA **re-trained w/ val+grammar** vs geometry-LoRA | label-free | cell@5_exact | MUST | TODO | fixes K2 — old control was unfair |
